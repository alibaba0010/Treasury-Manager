...
import { Bell, Menu, Search, User, LogOut, X, Wallet, Settings, Shield, Copy, Check } from "lucide-react"
...
const notifications = [
  {
    ...
    message: "Successfully moved $500K from USDY to OUSG based on AI recommendation",
    time: "2 minutes ago",
    type: "success",
    read: false,
  },
  {
    id: 2,
    title: "Risk Alert",
    message: "Portfolio deviation exceeded 5% threshold. Rebalancing recommended.",
    time: "15 minutes ago",
    type: "warning",
    read: false,
  },
  {
    id: 3,
    title: "Market Update",
    message: "Fed signals potential rate cut. AI adjusting strategy accordingly.",
    time: "1 hour ago",
    type: "info",
    read: false,
  },
  {
    ...
    message: "OUSG purchase of $250K completed successfully",
    time: "2 hours ago",
    type: "success",
    read: true,
  },
  {
    ...
    message: "Monthly compliance report generated and submitted",
    time: "1 day ago",
    type: "info",
    read: true,
  },
      ...
      <div className="flex h-16 items-center px-6 gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu open={notificationsOpen} onOpenChange={setNotificationsOpen}>
            ...
            <DropdownMenuContent align="end" className="w-96 p-0 notification-panel">
              <Card className="border-0 shadow-none bg-transparent">
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      {unreadCount > 0 && (
                        <Button variant="ghost" size="sm" onClick={markAllAsRead} className="text-xs hover-glow">
                          Mark all read
                        </Button>
                      )}
                      ...
                      {notificationList.map((notification) => (
                        <div
                          ...
                          className={`p-4 border-b border-border/50 hover:bg-gradient-to-r hover:from-primary/5 hover:to-primary/10 cursor-pointer transition-all duration-200 ${
                            !notification.read ? "bg-gradient-to-r from-primary/10 to-primary/5" : ""
                          }`}
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-80 p-0 profile-dropdown">
              <div className="p-6">
                ...
                <div className="bg-gradient-to-r from-muted/50 to-muted/20 rounded-lg p-3 mb-4">
                  ...
                  <div className="flex items-center justify-between">
                    <code className="text-sm font-mono bg-background/50 px-2 py-1 rounded">{walletAddress}</code>
                    <Button variant="ghost" size="sm" onClick={handleCopyAddress} className="h-6 w-6 p-0 hover-glow">
